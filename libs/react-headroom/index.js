...
import { isEqualWith as shallowequal } from 'lodash/lang'
import raf from 'raf'
import shouldUpdate from './shouldUpdate'
import isPassiveEventSupport from '../is-passive-event-support'
...
export default class extends Component {
  ...
  componentDidMount () {
    ...
    if (!this.props.disable) {
      this.props.parent().addEventListener('scroll', this.handleScroll, isPassiveEventSupport() ? { passive: true } : false)
    }
  }
